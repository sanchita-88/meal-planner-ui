...
const Signup = () => {
    ...
    // ... (inside the Signup component function)
        ...
        <div className="flex items-center justify-center w-full min-h-screen perspective-wrapper">
            ...
            <div className="w-full max-w-sm bg-white rounded-2xl shadow-2xl p-8 border border-gray-100 animate-scale-in">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    {/* 1. Email Input (FIXED ID/NAME/htmlFor) */}
                    <div>
                        <label htmlFor="email-signup" className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Email</label>
                    ...
                    {/* 2. Password Input (FIXED ID/NAME/htmlFor) */}
                    <div>
                        <label htmlFor="password-signup" className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Password</label>
                        <div className="flex items-center border border-gray-200 rounded-xl p-2.5 bg-white/50 focus-within:ring-2 focus-within:ring-pink-400 focus-within:border-pink-400 transition">
                    ...
                    {/* 3. Confirm Password Input (FIXED ID/NAME/htmlFor) */}
                    <div>
                        <label htmlFor="password-confirm" className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Confirm Password</label>
                        <div className="flex items-center border border-gray-200 rounded-xl p-2.5 bg-white/50 focus-within:ring-2 focus-within:ring-pink-400 focus-within:border-pink-400 transition">
                            <Lock size={18} className="text-gray-400 mr-2" />
                            <input
                                id="password-confirm"
                    ...
                    <button className="w-full bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white py-3 rounded-xl font-bold shadow-lg shadow-pink-200 transition-all transform hover:-translate-y-0.5 flex justify-center items-center gap-2 animate-pulse-button">
